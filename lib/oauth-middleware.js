(function() {
  var auth, authCallback, authorize, pocket, qs, redirect, request;
  ...
  authCallback = function(req, res, next, options) {
    return request.post({
      ...
      try {
        ...
        req.body.ret = ret;
        return options.afterSuccess(req, res, function(err) {
          if (err) {
            return next(err);
          }
  ...
  module.exports = auth = function(options) {
    ...
    options.afterSuccess || (options.afterSuccess = function() {});
